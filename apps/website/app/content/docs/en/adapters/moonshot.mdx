...
```bash tab="pnpm"
pnpm add @amux/llm-bridge @amux/adapter-moonshot
```

```bash tab="npm"
npm install @amux/llm-bridge @amux/adapter-moonshot
```
...
<Cards>
  <Card title="Qwen Adapter" href="/docs/en/adapters/qwen">
    Learn how to use Qwen models
  </Card>
  <Card title="DeepSeek Adapter" href="/docs/en/adapters/deepseek">
