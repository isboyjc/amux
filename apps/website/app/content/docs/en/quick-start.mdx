...
<Callout type="info">
This guide will walk you through creating your first Amux bridge. You'll learn how to convert between OpenAI and Anthropic formats in just a few minutes.
</Callout>
