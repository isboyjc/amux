...
<Callout type="info">
Amux is built on three core concepts: **Adapters**, **IR (Intermediate Representation)**, and **Bridge**. Understanding these concepts is key to using Amux effectively.
</Callout>

## Architecture Overview

Amux is built on three core concepts:
...
Adapters are the core of Amux. Each adapter implements two directions:
