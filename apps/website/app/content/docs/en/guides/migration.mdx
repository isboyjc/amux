...
<Callout type="info">
  Migrating to Amux is straightforward. Most code changes are mechanical
  replacements.
</Callout>
...
- Use `bridge.chatStreamRaw()` for streaming IR events
...
- [ ] Install Amux packages: `@amux.ai/llm-bridge`, `@amux.ai/adapter-*`
