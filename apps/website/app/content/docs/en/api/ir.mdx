...
IR is at the heart of the LLM Bridge, a unified format for all adapter conversions that captures all LLM functionality in a provider-agnostic manner, providing a common language understood by all adapters and enabling seamless conversions between any provider format.
...
<Tabs items={['Text', 'Image', 'Tool Use', 'Tool Result']}>
  <Tab value="Text">
    ### TextContent
  ...
  <Tab value="Tool Use">
    ...
    Anthropic-style tool call in message content.
  ...
  <Tab value="Tool Result">
    ### ToolResultContent

    Anthropic-style tool result in message content.
