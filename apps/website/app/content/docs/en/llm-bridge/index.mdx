...
| Moonshot | `@amux.ai/adapter-moonshot` | Chat, streaming, tools, reasoning |
| Zhipu (GLM) | `@amux.ai/adapter-zhipu` | Chat, streaming, tools, web search |
| Qwen | `@amux.ai/adapter-qwen` | Chat, streaming, tools, vision, reasoning |
| Gemini | `@amux.ai/adapter-google` | Chat, streaming, tools, vision |
| MiniMax | `@amux.ai/adapter-minimax` | Chat, streaming, tools, reasoning |
