...
| 提供商 | 包名 | 功能 |
|--------|------|------|
| OpenAI | `@amux/adapter-openai` | 聊天、流式、工具、视觉、JSON 模式 |
| Anthropic | `@amux/adapter-anthropic` | 消息、流式、工具、视觉、推理 |
| DeepSeek | `@amux/adapter-deepseek` | 聊天、流式、工具、推理 |
| Moonshot | `@amux/adapter-moonshot` | 聊天、流式、工具 |
| 智谱 (GLM) | `@amux/adapter-zhipu` | 聊天、流式、工具 |
| Qwen | `@amux/adapter-qwen` | 聊天、流式、工具、视觉 |
| Gemini | `@amux/adapter-google` | 聊天、流式、工具、视觉 |
