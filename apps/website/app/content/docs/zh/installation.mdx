...
| 包名 | 大小 | 描述 |
|------|------|------|
| `@amux/llm-bridge` | ~15KB | 核心包（必需）|
| `@amux/adapter-openai` | ~8KB | OpenAI 适配器 |
| `@amux/adapter-anthropic` | ~8KB | Anthropic 适配器 |
| `@amux/adapter-deepseek` | ~6KB | DeepSeek 适配器 |
| `@amux/adapter-moonshot` | ~6KB | Moonshot 适配器 |
| `@amux/adapter-zhipu` | ~6KB | 智谱适配器 |
| `@amux/adapter-qwen` | ~6KB | Qwen 适配器 |
| `@amux/adapter-google` | ~7KB | Google Gemini 适配器 |
