---
title: MiniMax 适配器
description: 使用 MiniMax 适配器连接到 MiniMax-M2.5 等模型,支持 Interleaved Thinking
---
...
- [MiniMax 文本生成指南](https://platform.minimax.io/docs/guides/text-generation)
- [OpenAI API 兼容](https://platform.minimax.io/docs/api-reference/text-openai-api)
- [MiniMax M2.5 发布](https://www.minimax.io/news/minimax-m25)
- [MiniMax M2.5 HuggingFace](https://huggingface.co/MiniMaxAI)
