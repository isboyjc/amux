...
describe('Kimi Adapter', () => {
  describe('Inbound - parseRequest', () => {
    it('should parse basic Kimi request to IR', () => {
      const request = {
      ...
      const ir = kimiAdapter.inbound.parseRequest(request)
  ...
  describe('Outbound - buildRequest', () => {
    it('should build Kimi request from IR', () => {
      const ir = {
        messages: [
      ...
      const request = kimiAdapter.outbound.buildRequest(ir)
  ...
  describe('Adapter Info', () => {
    it('should return correct adapter info', () => {
      const info = kimiAdapter.getInfo()
  ...
  describe('Stream Parsing', () => {
    it('should parse stream start event', () => {
      ...
      const event = kimiAdapter.inbound.parseStream(chunk)
